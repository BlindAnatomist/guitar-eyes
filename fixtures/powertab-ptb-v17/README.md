...
- `powertab-v17-original-six-position.source.json` describes the original musical content and explicit two-measure boundary.
...
The source is original Guitar Eyes test material with standard six-string tuning and two explicit measure regions separated by an internal legacy barline at source coordinate 50:

1. measure 1, low E fret 3, quarter note;
2. measure 1, A open, eighth note;
3. measure 1, A fret 2, eighth note;
4. measure 1, D open, half note;
5. measure 2, half-note rest;
6. measure 2, high E open plus B fret 1, half-note chord.
...
6. parity for title, tuning, explicit internal barline, six positions, coordinates, durations, rest, and final chord note count.
