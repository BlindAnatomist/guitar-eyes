...
# Normalizer proof defaults to actual GP8 semantic evidence.
...
# Direct binary proof derives evidence from generated bytes.
...
# Current implementation status records the corrected evidence.
