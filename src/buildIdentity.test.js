...
describe("checkpoint build identity", () => {
  test("places one format-only real-world Guitar Pro intake 5A identity before the React root", () => {
    ...
    const title =
      "<title>Test build Guitar Eyes format-only real-world Guitar Pro intake proof 5A</title>";
    const heading =
      '<h1 id="test-build-heading">Test build: Guitar Eyes format-only real-world Guitar Pro intake proof 5A.</h1>';
