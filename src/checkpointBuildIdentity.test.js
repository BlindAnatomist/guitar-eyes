...
describe("checkpoint build identity", () => {
  test("places one PowerTab version 11 clean convergence identity before the React root", () => {
    const html = fs.readFileSync(
      path.join(process.cwd(), "public", "index.html"),
      "utf8"
    );
    const title =
      "<title>Test build Guitar Eyes PowerTab version 11 clean convergence proof</title>";
    const heading =
      '<h1 id="test-build-heading">Test build: Guitar Eyes PowerTab version 11 clean convergence proof.</h1>';
