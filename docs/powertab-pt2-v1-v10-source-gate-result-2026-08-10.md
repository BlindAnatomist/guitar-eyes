# Historical PowerTab PT2 Source Gate Result

Workflow source commit: `a51c7887a9ea0f4a43593840c1aa5ba1cf117126`

Repository head after fail-forward fixture preservation: `d4b362978e7d70b6eda0ba07e0c5d5f663252274`

- fixture generation exit code: `0`
- fixture verification exit code: `0`
- npm ci exit code: `0`
- focused test exit code: `0`
- complete test exit code: `0`
- production build exit code: `0`

## Fixture generation

    
    > guitar-eyes@0.1.0 generate:powertab-pt2-historical-proofs
    > node scripts/generate-powertab-pt2-historical-proofs.mjs
    
    Generated 10 historical .pt2 proofs.

## Fixture verification

    Verified ten deterministic historical PT2 fixtures.
...
## Focused tests
    ...
    > react-scripts test --watchAll=false --runInBand src/powerTabHistoricalPt2Compatibility.test.js src/powerTabPt2Decoder.test.js src/powerTabV11Decoder.test.js src/powerTabSourceNormalizer.test.js src/powerTabReaderDocuments.test.js src/powerTabTrackInventory.test.js src/structuredTabReaderDocuments.test.js
    
    PASS src/powerTabV11Decoder.test.js
    PASS src/powerTabPt2Decoder.test.js
    PASS src/powerTabSourceNormalizer.test.js
    PASS src/powerTabHistoricalPt2Compatibility.test.js
    PASS src/structuredTabReaderDocuments.test.js
    ...
    Snapshots:   0 total
    Time:        1.736 s
    Ran all test suites matching /src\/powerTabHistoricalPt2Compatibility.test.js|src\/powerTabPt2Decoder.test.js|src\/powerTabV11Decoder.test.js|src\/powerTabSourceNormalizer.test.js|src\/powerTabReaderDocuments.test.js|src\/powerTabTrackInventory.test.js|src\/structuredTabReaderDocuments.test.js/i.
...
## Production build
    ...
    File sizes after gzip:
      ...
      107.39 kB  build/static/js/main.b535b291.js
      10.29 kB   build/static/js/732.5b89a420.chunk.js
      9.85 kB    build/static/js/982.1a1967ca.chunk.js
